...
public class BestToSellAndBuyStockWithCoolDown {
    ...
    public static int helper(int[] prices,int[][] dp, int day,int buyStatus){
        ...
        if(buyStatus == 1){
            ...
            int sellStock = prices[day] + helper(prices, dp, day+2, 1);  // We are selling our holding stock we are gaining some amount irrespective of the cost of stock on the current day. After selling the stock the buyStatus changes to 1 and now on we can proceed with buying another stock.
